...
#include "BP_FPSBlackHole.h"
#include "Components/SphereComponent.h"
#include "Components/StaticMeshComponent.h"

// Sets default values
ABP_FPSBlackHole::ABP_FPSBlackHole()
{
	...
	InnerSphereComponent->OnComponentBeginOverlap.AddDynamic(this, &ABP_FPSBlackHole::OverlapInnerSphere);
...
void ABP_FPSBlackHole::BeginPlay()
{
	Super::BeginPlay();
	
}

void ABP_FPSBlackHole::OverlapInnerSphere(UPrimitiveComponent * OverlappedComponent, AActor* OtherActor, UPrimitiveComponent * OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult & SweepResult)
{
	if (OtherActor)
	{
		OtherActor->Destroy();
...
// Called every frame
void ABP_FPSBlackHole::Tick(float DeltaTime)
{
